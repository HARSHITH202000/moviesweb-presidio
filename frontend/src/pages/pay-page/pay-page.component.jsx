    ...
    render() {
        return(
            <div className='pay-container'>
                <h2>Booking {this.props.match.params.seat} seats at {this.props.match.params.show}hrs on {this.props.match.params.date} of {this.props.match.params.Title.replace(/\+/g, " ")}</h2>
